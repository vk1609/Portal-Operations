...
<form class="form-horizontal" action="registration_code.php" method="POST">
  ...
  <!-- <div class="form-group">
    <label class="control-label col-sm-2" for="pwd" hidden>Status:</label>
    <div class="col-sm-6"> 
    <input type="activity" name="activity" value="Off Duty" class="form-control" id="pwd" placeholder="Enter password" hidden>
